...
evaluation = dict(interval=9010)
checkpoint_config = dict(interval=9010)
runner = dict(max_iters=9010)
optimizer = dict(lr=0.02) # 原来是0.02
# model settings
model = dict(roi_head=dict(bbox_head=dict(num_classes=7, num_meta_classes=7)))